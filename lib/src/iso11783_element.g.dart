...
abstract class _$AttachedFileCWProxy {
  ...
  AttachedFile manufacturerGLN(Uri manufacturerGLN);
...
const $Iso11783TagEnumMap = {
  Iso11783Tag.allocationStamp: 'ASP',
  Iso11783Tag.attachedFile: 'AFE',
  Iso11783Tag.baseStation: 'BSN',
  Iso11783Tag.codedComment: 'CCT',
  Iso11783Tag.codedCommentGroup: 'CCG',
  Iso11783Tag.codedCommentListValue: 'CCL',
  Iso11783Tag.colourLegend: 'CLD',
  Iso11783Tag.colourRange: 'CRG',
  Iso11783Tag.commentAllocation: 'CAN',
  Iso11783Tag.connection: 'CNN',
  Iso11783Tag.controlAssignment: 'CAT',
  Iso11783Tag.cropType: 'CTP',
  Iso11783Tag.cropVariety: 'CVT',
  Iso11783Tag.culturalPractice: 'CPC',
  Iso11783Tag.customer: 'CTR',
  Iso11783Tag.dataLogTrigger: 'DLT',
  Iso11783Tag.dataLogValue: 'DLV',
  Iso11783Tag.device: 'DVC',
  Iso11783Tag.deviceAllocation: 'DAN',
  Iso11783Tag.deviceElement: 'DET',
  Iso11783Tag.deviceObjectReference: 'DOR',
  Iso11783Tag.deviceProperty: 'DPT',
  Iso11783Tag.deciveProcessData: 'DPD',
  Iso11783Tag.deviceValuePresentation: 'DVP',
  Iso11783Tag.externalFileContents: 'XFC',
  Iso11783Tag.externalFileReference: 'XFR',
  Iso11783Tag.farm: 'FRM',
  Iso11783Tag.grid: 'GRD',
  Iso11783Tag.guidanceAllocation: 'GAN',
  Iso11783Tag.guidanceGroup: 'GGP',
  Iso11783Tag.guidancePattern: 'GPN',
  Iso11783Tag.guidanceShift: 'GST',
  Iso11783Tag.lineString: 'LSG',
  Iso11783Tag.link: 'LNK',
  Iso11783Tag.linkGroup: 'LGP',
  Iso11783Tag.linkList: 'ISO11783LinkList',
  Iso11783Tag.operationTechnique: 'OTQ',
  Iso11783Tag.operationTechniquePractice: 'OTP',
  Iso11783Tag.operationTechniqueReference: 'OTR',
  Iso11783Tag.partfield: 'PFD',
  Iso11783Tag.polygon: 'PLN',
  Iso11783Tag.point: 'PNT',
  Iso11783Tag.position: 'PTN',
  Iso11783Tag.processDataVariable: 'PDV',
  Iso11783Tag.product: 'PDT',
  Iso11783Tag.productAllocation: 'PAN',
  Iso11783Tag.productGroup: 'PGP',
  Iso11783Tag.productRelation: 'PRN',
  Iso11783Tag.task: 'TSK',
  Iso11783Tag.taskControllerCapabilities: 'TCC',
  Iso11783Tag.taskData: 'ISO11783_TaskData',
  Iso11783Tag.time: 'TIM',
  Iso11783Tag.timeLog: 'TLG',
  Iso11783Tag.treatmentZone: 'TZN',
  Iso11783Tag.valuePresentation: 'VPN',
  Iso11783Tag.worker: 'WKR',
  Iso11783Tag.workerAllocation: 'WAN',
  Iso11783Tag.emptyElement: ''
};

const $VersionMajorEnumMap = {VersionMajor.three: '3', VersionMajor.four: '4'};

const $VersionMinorEnumMap = {
  VersionMinor.zero: '0',
  VersionMinor.one: '1',
  VersionMinor.two: '2',
...
void _$AttachedFileBuildXmlChildren(AttachedFile instance, XmlBuilder builder,
  ...
  final manufacturerGLNSerialized = manufacturerGLN.toString();
...
AttachedFile _$AttachedFileFromXmlElement(XmlElement element) {
  ...
  return AttachedFile(
      ...
      preserve: $PreserveEnumMap.entries
          ...
          .key,
      manufacturerGLN: Uri.parse(manufacturerGLN),
...
List<XmlAttribute> _$PartfieldToXmlAttributes(Partfield instance,
  ...
  final areaSerialized = area?.toString();
  final areaConstructed = areaSerialized != null
      ? XmlAttribute(XmlName('D'), areaSerialized)
      : null;
  if (areaConstructed != null) {
    attributes.add(areaConstructed);
  }
