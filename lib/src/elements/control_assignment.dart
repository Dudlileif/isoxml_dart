...
/// An element that binds controls from a source [Device] to a user [Device].
///
...
class ControlAssignment extends Iso11783Element
  ...
  const ControlAssignment._({
    ...
    this.allocationStamp,
          ...
          tag: Iso11783Tag.controlAssignment,
  ...
  /// Client name of the source of the assignement.
  @annotation.XmlAttribute(name: 'A')
  final String sourceClientNAME;

  /// Client name of the user of the assignment.
