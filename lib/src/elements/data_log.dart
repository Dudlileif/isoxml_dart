...
class DataLogTrigger extends Iso11783Element
  ...
  const DataLogTrigger._({
    ...
    this.pgnStartBit,
    this.pgnStopBit,
  }) : super(tag: Iso11783Tag.dataLogTrigger, description: 'DataLogTrigger');
...
class DataLogValue extends Iso11783Element
  ...
  const DataLogValue._({
    ...
    this.pgnStartBit,
    this.pgnStopBit,
  }) : super(tag: Iso11783Tag.dataLogValue, description: 'DataLogValue');
  ...
  ///
  /// The [ProcessDataVariable] is found as a Device Dictionary Entity (DDE)
  /// in the ISO 11783-11 online database.
  @annotation.XmlAttribute(name: 'A')
